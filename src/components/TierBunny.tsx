...
function CostumeBack({ costume }: { costume: string }) {
  switch (costume) {
    ...
    case 'samurai': return <><path d="M22 72 L10 94 L27 98" fill="#253551" /><path d="M98 72 L110 94 L93 98" fill="#253551" /></>;
...
function Outfit({ costume }: { costume: string }) {
  switch (costume) {
    ...
    case 'samurai': return <><path d="M29 83 Q60 75 91 83 L87 120 Q60 127 33 120 Z" fill="#315076" /><path d="M33 89 H87 M32 99 H88 M32 109 H88" stroke="#e5b94d" strokeWidth="2" opacity=".9" /><rect x="42" y="84" width="36" height="37" rx="8" fill="#3d5e86" stroke="#203650" strokeWidth="2" /></>;
...
function Headwear({ costume }: { costume: string }) {
  switch (costume) {
    ...
    case 'samurai': return <><path d="M25 55 Q29 27 60 26 Q91 27 95 55 Q60 47 25 55" fill="#2b3d59" stroke="#18283e" strokeWidth="2" /><path d="M22 55 Q60 68 98 55 L94 65 Q60 75 26 65 Z" fill="#21334d" /><path d="M42 31 Q60 10 78 31 Q66 25 60 38 Q54 25 42 31" fill="#e5b94d" /><circle cx="60" cy="42" r="6" fill="#d84f55" stroke="#f1c85d" strokeWidth="2" /></>;
